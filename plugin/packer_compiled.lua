...
_G.packer_plugins = {
  ...
  ["obsidian.nvim"] = {
    loaded = true,
    path = "/Users/joseph.rojo/.local/share/nvim/site/pack/packer/start/obsidian.nvim",
  ...
  ["telescope.nvim"] = {
    loaded = true,
    path = "/Users/joseph.rojo/.local/share/nvim/site/pack/packer/start/telescope.nvim",
